...
namespace PatientCare.Shared
{
    ...
    public static class DataHandler
    {
        ...
        public static void SaveCategoriesToLocalDatabase(DAL db, CategoryEntity[] categories)
        {
        ...
        public static void SaveCallsToLocalDatabase(DAL db, CallEntity[] calls)
        {
            if (calls != null)
            {
        ...
        public static void UpdateMyCallToLocalDatabase(DAL db, CallEntity callEntity)
        {
            if (callEntity != null)
            {
        ...
        public static CategoryEntity[] LoadCategoriesFromLocalDatabase(DAL db)
        {
        ...
        /// <param name="db">Den delte database PCL</param>
        /// <returns></returns>
        public static CallEntity[] LoadCallsFromLocalDatabase(DAL db)
        {
            try
            {
                CallEntity[] calls = db.LoadMyCalls().ToArray();
                if (calls != null)
                {
                    return calls;
                }
            ...
            return new List<CallEntity>().ToArray();
            
        }

        public static void DeleteCategoriesFromLocalDatabase(DAL db)
        {
            db.DeleteCategories();
        }
    }
