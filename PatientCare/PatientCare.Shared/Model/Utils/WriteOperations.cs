...
using PatientCare.Shared.Model.Exceptions;
using PatientCare.Shared.Model.Extensions;
using PatientCare.Shared.Model.Extensions.TextBlob;
using SQLite.Net;
using SQLite.Net.Attributes;

namespace PatientCare.Shared.Model.Utils
{
